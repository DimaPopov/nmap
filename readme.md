...
<br>После выполнения поиска загрузиться список из пользователей, который можно прокручивать _(если найдено много пользователей)_. Если нажать на карточку пользователя, то откроеться дополниетльная информация о нем, там всегда будет дата регистрации. Также будет выведен список спеицальных прав, это права которые можно получить только по заявке.

> Информация о специальных правах у сотрудников Яндекса не отображаеться
...
<br>Если пользователь определён или подозреваеться Яндексам как спаммер, то будет предупреждение в виде восклицтального знака восле автарки, который отображаеться всегда. А при просмотре дополнительной информации будет описание предупреждения.
...
<br><br><br><br>Если сотрудник или пользователь удалён, то будет информация о том, кто и когда удалил пользователя/уволил сотрудника. А также по какой причине это произашло.
...
> ❗ Проверка осуществляеться исключиетльно на основании введеных Вами данных, перед внесением каких-либо изменений удостовертьесь в их корректности
...
<br>При клике на кнопку **Проверить адреса** откроеться окно подготовки проверки адресов. В нем уже есть название улицы или АТД, все что Вам надо, указать номера домов.

Расширение постараеться автоматический исправить:
...
<br>Результат проверки содержим номера домов, при наведении на них будет отображено полное название адреса. По номерам, которые подсвеченны синим можно перейти в карточку объекта адреса
